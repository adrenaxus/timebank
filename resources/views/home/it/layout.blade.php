...
<html lang="en">
    ...
    <head>
		...
		<meta name="description" content="Die Banca dl Tëmp Gherdëina ist eine soziale Einrichtung, ein Verein ohne Gewinnabsicht, die das Ziel verfolgt, den unentgeltlichen Austausch vonDiensten und Tätigkeiten zu unterstützen.">
		<meta name="author" content="">

		<title>Banca del tempo - S. Cristina</title>
		...
		<div class="container">
		  ...
		  <div class="collapse navbar-collapse" id="navbarResponsive">
			<ul class="navbar-nav ml-auto">
			  <li class="nav-item mx-0 mx-lg-1">
				<a class="nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger" href="#banca-del-tempo">Banca del tempo</a>
			  </li>		
			  <li class="nav-item mx-0 mx-lg-1">
				<a class="nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger" href="#offerte">offerte <span class="badge bade-pill badge-success">
					{{  App\Entry::where('type', 'offer')->get()->count() }}
				</span></a>
			  </li>
			  <li class="nav-item mx-0 mx-lg-1">
				<a class="nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger" href="#richieste">richieste <span class="badge bade-pill badge-success">
					{{  App\Entry::where('type', 'request')->get()->count() }}
				</span></a>
			  </li>		  
			  <li class="nav-item mx-0 mx-lg-1">
				<a class="nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger" href="#contatto">contatto</a>
			  </li>
			</ul>
				<div class="my-2 my-lg-0">
					<ul class="navbar-nav mr-auto">
						@if (Route::has('login'))
							@auth
								<li class="nav-item"><a class="nav-link text-primary" href="/btg">Accedi</a></li>
							@else
			...
			<ul class="navbar-nav languages">
				...
				<li class="nav-item"><a class="active" href="/it">it</a></li>
		 ...
		 @yield('content')
			  ...
			  <div class="row">
				...
				<div class="col-lg-4 ml-auto">
				  <p class="lead text-center">
					...
					Piazza S. Durich, 9<br>
					Telefono: 0471 797 814<br>
					ogni mercoledì, dalle ore 16.00 alle ore 18.00
				  </p>
				</div>
				...
				<div class="col-lg-4 mr-auto">
				  <p class="lead text-center">
					Sede Selva:<br>
					Biblioteca O.v. Wolkenstein<br>
					Via Nives, 16/3<br>
					Telefono: 0471 772 181<br>
		  ...
		  <div class="copyright py-4 text-center text-white">
			<div class="container">
			  <small>Copyright &copy; Banca del tempo 2019</small>
			</div>
		  </div>
